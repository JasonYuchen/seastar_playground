...
template <>
struct serializer<bool> : public detail::numeric_serializer<bool> {};
template <>
struct serializer<int8_t> : public detail::numeric_serializer<int8_t> {};
template <>
struct serializer<uint8_t> : public detail::numeric_serializer<uint8_t> {};
template <>
struct serializer<int16_t> : public detail::numeric_serializer<int16_t> {};
template <>
struct serializer<uint16_t> : public detail::numeric_serializer<uint16_t> {};
template <>
struct serializer<int32_t> : public detail::numeric_serializer<int32_t> {};
template <>
struct serializer<uint32_t> : public detail::numeric_serializer<uint32_t> {};
template <>
struct serializer<int64_t> : public detail::numeric_serializer<int64_t> {};
template <>
struct serializer<uint64_t> : public detail::numeric_serializer<uint64_t> {};
template <>
struct serializer<float> : public detail::numeric_serializer<float> {};
template <>
...
template <typename T>
struct serializer<std::vector<T>> : public detail::vector_serializer<T> {};
template <typename T>
struct serializer<std::set<T>> : public detail::set_serializer<T> {};
template <typename T>
struct serializer<std::unordered_set<T>>
  : public detail::unordered_set_serializer<T> {};
template <typename K, typename V>
struct serializer<std::map<K, V>> : public detail::map_serializer<K, V> {};
template <typename K, typename V>
